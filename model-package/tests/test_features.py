...
def test_feature_engineering_transformers(sample_input_data):
    ...
    cabin_extractor = ExtractLetterTransformer(variables=config.model_config.variable_to_get_cabin_goup)
    title_extractor = ExtractTitleTransformer(variable=config.model_config.variable_to_extract_title)
